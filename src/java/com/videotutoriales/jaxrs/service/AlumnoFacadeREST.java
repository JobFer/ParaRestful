package com.videotutoriales.jaxrs.service;

import com.videotutoriales.jaxrs.Alumno;
...
@Stateless
@Path("com.videotutoriales.jaxrs.alumno")
public class AlumnoFacadeREST extends AbstractFacade<Alumno> {

    @PersistenceContext(unitName = "ParaRestfulPU")
